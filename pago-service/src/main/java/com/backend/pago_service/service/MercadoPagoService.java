...
public class MercadoPagoService {
    ...
    public PreferenceResponseDTO createPreference(Long reservaId, Long solicitanteId, boolean esAdmin)
        ...
        PreferencePayerRequest payer = PreferencePayerRequest.builder()
                .name(reserva.nombreComprador())
                .email(reserva.telefonoComprador() + "@dummy.com") // Required valid-looking email
                .build();
        ...
        log.info("Creando preferencia con backUrls: success={}, failure={}, pending={}", backUrlSuccess, backUrlFailure, backUrlPending);
